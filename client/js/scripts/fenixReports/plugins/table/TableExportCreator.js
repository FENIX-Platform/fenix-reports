define(['jquery'], function ($) {
    ...
    TableExportCreator.prototype.process = function (config) {
    ...
    TableExportCreator.prototype.validateConfig = function (config) {
