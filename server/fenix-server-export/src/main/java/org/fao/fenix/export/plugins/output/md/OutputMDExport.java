...
public class OutputMDExport extends Output {
    ...
    private void compileData(Document document, MeIdentification meIdentification) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        ...
        "         },\n" +
        "         \"description\":\"Value assigned to the cells to represent the absence of data. Missing values are usually highlight through apposite ags, however the data matrix does not report empty cells but a prede\fned combination of characters (such as 'NA', '000' . . . ) indicating the absence of data.\",\n" +
        "         \"description_i18n\":{  \n" +
        "            \"en\":\"Value assigned to the cells to represent the absence of data. Missing values are usually highlight through apposite ags, however the data matrix does not report empty cells but a prede\fned combination of characters (such as 'NA', '000' . . . ) indicating the absence of data.\"\n" +
        "         }\n" +
        "      },\n" +
        "      \"meDocuments\":{  \n" +
        "         \"type\":\"array\",\n" +
        ...
        "                     },\n" +
        "                     \"description\":\"Coded information describing the degree of con\fdentiality of the resource.\",\n" +
        "                     \"description_i18n\":{  \n" +
        "                        \"en\":\"Coded information describing the degree of con\fdentiality of the resource.\"\n" +
        "                     },\n" +
        "                     \"$ref\":\"#/definitions/OjCodeList\"\n" +
        "                  }\n" +
        "               }\n" +
        ...
        "               },\n" +
        "               \"description\":\"Definitions of the statistical concepts under measure (i.e. the statistical domain) and the main variables provided. The considered types of variables (e.g. raw figures, annual growth rates, index, ow or stock data, ...) should be de\fned and described in accordance with internationally accepted statistical standards, guidelines, or good practices.\",\n" +
        "               \"description_i18n\":{  \n" +
        "                  \"en\":\"Definitions of the statistical concepts under measure (i.e. the statistical domain) and the main variables provided. The considered types of variables (e.g. raw figures, annual growth rates, index, ow or stock data, ...) should be de\fned and described in accordance with internationally accepted statistical standards, guidelines, or good practices.\"\n" +
        "               },\n" +
        "               \"patternProperties\":{  \n" +
        "                  \".{1}\":{  \n" +
        "                     \"type\":\"string\"\n" +
        ...
        "                     },\n" +
        "                     \"description\":\"Specific time periods (e.g. a day, a week, a month, a \fscal year, a calendar year or several calendar years) the statistical variables refer to.\",\n" +
        "                     \"description_i18n\":{  \n" +
        "                        \"en\":\"Specific time periods (e.g. a day, a week, a month, a \fscal year, a calendar year or several calendar years) the statistical variables refer to.\"\n" +
        "                     },\n" +
        "                     \"$ref\":\"#/definitions/OjCodeList\"\n" +
        "                  },\n" +
        "                  \"referenceArea\":{  \n" +
        ...
        "                     },\n" +
        "                     \"description\":\"Type of geographical units the resource represents or refers to. Note that the spatial resolution must refer to the minimum mapping unit whose bounds are o\u000Ecially recognized indipendently from the measurement process of the phonomenon taken into account. Examples are: countries, administrative level 2, etc.\",\n" +
        "                     \"description_i18n\":{  \n" +
        "                        \"en\":\"Type of geographical units the resource represents or refers to. Note that the spatial resolution must refer to the minimum mapping unit whose bounds are o\u000Ecially recognized indipendently from the measurement process of the phonomenon taken into account. Examples are: countries, administrative level 2, etc.\"\n" +
        "                     },\n" +
        "                     \"$ref\":\"#/definitions/OjCodeList\"\n" +
        "                  }\n" +
        "               }\n" +
        ...
        JsonNode actualObj = null;// since 2.1 use mapper.getFactory() instead
        try {
     ...
     /*   JsonNode node = null;
        ObjectMapper mapper = new ObjectMapper();
        node = mapper.valueToTree(result);
*/
